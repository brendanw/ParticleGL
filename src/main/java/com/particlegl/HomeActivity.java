...
public class HomeActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (supportsEs2) {
			...
			/*
			 * This is where you could create an OpenGL ES 1.x compatible renderer if
			 * you wanted to support both ES 1 and ES 2. Since we're not doing
			 * anything, the app will crash if the device doesn't support OpenGL ES
			 * 2.0. If we publish on the market, we should also add the following to
			 * AndroidManifest.xml:
			 * 
			 * <uses-feature android:glEsVersion="0x00020000" android:required="true"
			 * />
			 * 
			 * This hides our app from those devices which don't support OpenGL ES
			 * 2.0.
			 */
